...
const stageOffsets: Record<InteractiveProductionStage, InteractiveStoryPosition> = {
  ...
  sceneMaster: { x: 1_560, y: 0 },
  marbleWorld: { x: 1_950, y: 0 },
  spatialRegistration: { x: 2_340, y: 0 },
  blocking: { x: 2_730, y: 0 },
  coverage: { x: 3_120, y: 0 },
  previs: { x: 3_510, y: 0 },
  previsValidation: { x: 3_900, y: 0 },
  formalGeneration: { x: 4_290, y: 0 },
  multicamEdit: { x: 4_680, y: 0 },
  supervision: { x: 5_070, y: 0 },
};
